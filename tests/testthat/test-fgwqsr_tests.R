...
# commented out because we do not want to reuire user to have JAGS installed to use package.
# Instead, will have a check in BGWQSR that they need to download JAGS if no JAGS
# module is detected.
